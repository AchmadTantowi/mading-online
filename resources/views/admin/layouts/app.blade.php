...
<head>
  ...
  <title>Mading Online | Dashboard</title>
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2018 Mading Online.</strong> All rights
    reserved.
  </footer>
...
<!-- jQuery UI 1.11.4 -->
<script src="{{ asset('assets/backend/plugins/jquery-ui.min.js') }}"></script>
